...
export default function IndexPage() {
  ...
  return (
    <div>
      ...
      <Series pageIndex={pageIndex} orderBy='-modified' />
      <div style={{ display: 'none' }}><Series pageIndex={pageIndex + 1} titleStartsWith={titleStartsWith} orderBy='-modified' noVariants={false} /></div>
